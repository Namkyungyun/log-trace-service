...
import com.example.nk.logtracer.config.v2_dynamicproxy.handler.LogTraceFilterHandler;
...
public class DynamicProxyFilterConfig {
    ...
    ProxyOrderRepositoryV1 proxyOrderRepositoryV1(LogTrace logTrace) {
        ...
        final LogTraceFilterHandler handler = new LogTraceFilterHandler(logTrace, target, PATTERNS );
